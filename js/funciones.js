...
function consultarCliente(){
    ...
    $.ajax({
        url:'http://132.226.250.48:8084/api/Client/all',
        type:'GET',
        datatype:'JSON',
...
function validarCliente(idCliente){
    ...
    $.ajax({
        url:"http://132.226.250.48:8084/api/Client/"+idCliente,
        type:"GET",
        success:function(respuesta){
...
function adicionarCliente(){
    if ($("#name").val() != "" && $("#email").val() != "" && $("#age").val() != "" && $("#password").val() != "") {
        ...
        $.ajax({
            url:"http://132.226.250.48:8084/api/Client/save",
...
function actualizarCliente(idCliente1){
    if ($("#name").val() != "" && $("#email").val() != "" && $("#age").val() != "") {
        ...
        $.ajax({
            url:"http://132.226.250.48:8084/api/Client/update",
            type:"PUT",
            data:dataToSend,
 ...
 * */
 function consultarCabaña(){
    ...
    $("#listCategory").val("0");    
    $.ajax({
        url:'http://132.226.250.48:8084/api/Cabin/all',
        type:'GET',
        datatype:'JSON',
        success:function(respuesta){
...
function validarCabaña(idCabaña){
    ...
    $.ajax({
        url:"http://132.226.250.48:8084/api/Cabin/"+idCabaña,
        type:"GET",
        success:function(respuesta){
            if (respuesta.messages[0] === undefined && respuesta.reservations[0] === undefined) {
...
function adicionarCabaña(){
    if ($("#brand").val() != "" && $("#rooms").val() != "" && $("#description").val() != "" && $("#name1").val() != "" && $("#listCategory").val() != "0") {
        ...
        $.ajax({
            url:"http://132.226.250.48:8084/api/Cabin/save",
            contentType: "application/json; charset=utf-8",
            type:"POST",
            data:dataToSend,
            datatype:"JSON",
...
function actualizarCabaña(idCabaña){
    if ($("#brand").val() != "" && $("#rooms").val() != "" && $("#description").val() != "" && $("#name1").val() != "" && $("#listCategory").val() != "0") {
        ...
        $.ajax({
            url:"http://132.226.250.48:8084/api/Cabin/update",
            type:"PUT",
            data:dataToSend,
            contentType:"application/JSON",
            datatype:"JSON",
 ...
 */
 ...
 function consultarCategoria(){
    ...
    $("#description2").val("");
    $.ajax({
        url:'http://132.226.250.48:8084/api/Category/all',
        type:'GET',
        datatype:'JSON',
        success:function(respuesta){
            console.log(respuesta);
...
function validarCategoria(idCategoria){
    ...
    $.ajax({
        url:"http://132.226.250.48:8084/api/Category/"+idCategoria,
        type:"GET",
        success:function(respuesta){
...
function adicionarCategoria(){
    if ($("#name2").val() != "" && $("#description2").val() != "") {
        ...
        $.ajax({
            url:'http://132.226.250.48:8084/api/Category/save',
            contentType: "application/json; charset=utf-8",
            type:"POST",
            data:dataToSend,
            datatype:"JSON",
...
function actualizarCategoria(idCategoria){
    if ($("#name2").val() != "" && $("#description2").val() != "") {
        ...
        $.ajax({
            url:'http://132.226.250.48:8084/api/Category/update',
            contentType: "application/json; charset=utf-8",
            type:"PUT",
            data:dataToSend,
            datatype:"JSON",
 ...
 */
 ...
 function consultarMensaje(){
    ...
    $()
    $.ajax({
        url:'http://132.226.250.48:8084/api/Message/all',
        type:'GET',
        datatype:'JSON',
        success:function(respuesta){
            console.log(respuesta);
...
function borrarMensaje(idMensaje){
    ...
    $.ajax({
        url:"http://132.226.250.48:8084/api/Message/" + idMensaje,
        type:"DELETE",
        success:function(respuesta){
            consultarMensaje();
...
function adicionarMensaje(){
    if ($("#messagetext").val() != "" && $("#listCabin").val() != "0" && $("#listClient").val() != "0") {
        ...
        $.ajax({
            url:"http://132.226.250.48:8084/api/Message/save",
            contentType: "application/json; charset=utf-8",
            type:"POST",
            data:dataToSend,
            datatype:"JSON",
...
console.log(dataJSON)
        ...
        $.ajax({
            url:"http://132.226.250.48:8084/api/Message/update",
            type:"PUT",
            data:dataToSend,
            contentType:"application/JSON",
            datatype:"JSON",
...
function consultarReservacion(){
    ...
    $("#listClient1").val("0");    
    $.ajax({
        url:'http://132.226.250.48:8084/api/Reservation/all',
        type:'GET',
        datatype:'JSON',
        success:function(respuesta){
            console.log(respuesta);
...
function borrarReservacion(idReservation){
    ...
    $.ajax({
        url:"http://132.226.250.48:8084/api/Reservation/" + idReservation,
        type:"DELETE",
        success:function(respuesta){
...
function adicionarReservacion(){
    if ($("#startDate").val() != "" && $("#endDate").val() != "" && $("status").val() != "" && $("#score").val() != "" && $("#listCabin1").val() != "0" && $("#listClient1").val() != "0") {
        ...
        $.ajax({
            url:"http://132.226.250.48:8084/api/Reservation/save",
            contentType: "application/json; charset=utf-8",
            type:"POST",
            data:dataToSend,
            datatype:"JSON",
...
function actualizarReservacion(idReservation1){
    if ($("#startDate").val() != "" && $("#endDate").val() != "" && $("status").val() != "" && $("#score").val() != "" && $("#listCabin1").val() != "0" && $("#listClient1").val() != "0") {
        ...
        $.ajax({
            url:"http://132.226.250.48:8084/api/Reservation/update",
            type:"PUT",
            data:dataToSend,
            contentType:"application/JSON",
            datatype:"JSON",
